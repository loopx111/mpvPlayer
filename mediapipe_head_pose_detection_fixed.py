...
def main():
    print("基于MediaPipe的头部姿态与注视检测 - 修复版")
    print("修复问题：1.人脸移开后检测框残留 2.推理时间显示0.0ms")
    print("=" * 70)
    ...
    while True:
        ...
        cv2.imshow('MediaPipe Head Pose Detection - Fixed', display_frame)
        ...
        if key == ord('q'):
            ...
            cv2.imwrite("mediapipe_head_pose_frame_fixed.jpg", frame_flipped)
            print("保存当前帧到: mediapipe_head_pose_frame_fixed.jpg")
